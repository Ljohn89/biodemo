[![travis](https://travis-ci.org/Ljohn89/biodemo.svg?branch=master)](https://travis-ci.org/Ljohn89/biodemo)
...
2016-12-04T19:14:47 command line: /usr/local/bin/biodemo --log bt.log file1.fasta file2.fasta
...
You can run the unit tests for biodemo with the following commands:
```
